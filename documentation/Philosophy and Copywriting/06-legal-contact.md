...
> Contact : contact@kelen.com

---

### Hébergement

> Le site kelen.com est hébergé par :
> Vercel Inc.
> 340 Pine Street, Suite 701
> San Francisco, CA 94104, États-Unis
>
> Les données des utilisateurs européens sont stockées et traitées dans des serveurs situés en Union Européenne conformément au RGPD.

---

### Propriété intellectuelle

> L'ensemble du contenu de ce site — textes, structure, logique de présentation — est la propriété exclusive de Kelen SAS.
>
> Les témoignages et dossiers soumis par les utilisateurs restent leur propriété. En les soumettant, ils accordent à Kelen une licence d'utilisation non exclusive pour les publier sur la plateforme conformément aux conditions générales d'utilisation.
...
> Kelen collecte le minimum de données nécessaires au fonctionnement de la plateforme. Nous ne vendons pas vos données. Nous ne les partageons pas avec des tiers à des fins commerciales.
>
> Cette page explique ce que nous collectons, pourquoi, et comment vous pouvez exercer vos droits.
...
> Lors de l'inscription : email, nom, coordonnées professionnelles, informations d'entreprise.
>
> Lors de l'utilisation : historique de connexion, données de facturation, statistiques de visibilité. Ces données sont nécessaires au fonctionnement du tableau de bord et à la facturation.
>
> Données financières : les informations de paiement sont traitées par nos prestataires de paiement — Stripe et Wave. Kelen ne stocke pas les numéros de carte bancaire.
...
>
> **Sécurité** — Détection de soumissions frauduleuses, protection contre les abus.
>
> **Amélioration de la plateforme** — Analyse agrégée et anonymisée de l'utilisation pour améliorer les fonctionnalités.
...
> Nous ne les partageons pas avec des partenaires commerciaux.
> Nous n'utilisons pas vos données pour vous cibler publicitairement sur d'autres plateformes.
...
>
> **Suppression** — Demander la suppression de vos données, dans les limites définies par nos CGU et nos obligations légales.
>
> **Portabilité** — Recevoir vos données dans un format structuré et lisible par machine.
>
> **Opposition** — Vous opposer au traitement de vos données dans certains cas.
>
> Pour exercer ces droits : rgpd@kelen.com
...
> Kelen utilise uniquement des cookies techniques nécessaires au fonctionnement de la plateforme — session utilisateur, préférences de langue.
>
> Aucun cookie publicitaire. Aucun tracker tiers. Aucune bannière cookie intempestive — parce qu'il n'y a rien à accepter au-delà du strict nécessaire.

---

## Conditions générales d'utilisation — Sections clés
...
### Section 4 — Responsabilités des professionnels
...
**Introduction :**
> Selon votre situation, plusieurs canaux sont disponibles. Choisissez celui qui correspond à votre besoin.
...
> Kelen ne fournit pas de conseil juridique et ne peut pas intervenir dans les litiges entre utilisateurs et professionnels. Pour ces situations, consultez les autorités compétentes de votre pays.

---

## Page À propos

**Titre :** À propos de Kelen
