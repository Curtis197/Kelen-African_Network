...
## Inscription professionnel — 3 étapes
...
**Titre :** Votre activité professionnelle
...
Décrivez ce que vous faites, pas ce que vous êtes.
```

**Note sur la description :**
> Exemple utile : "Construction résidentielle et rénovation à Abidjan depuis 2009."
> Exemple à éviter : "Professionnel sérieux et expérimenté."
...
**Titre :** Paramètres de votre compte
...
[Désactiver temporairement mon profil]
Votre profil ne sera plus visible dans les résultats.
Votre historique et votre statut sont conservés.
...
## Page de lien d'une recommandation
...
○ Oui, ce projet est le mien — lier à mon profil

○ Non, je ne reconnais pas ce projet
```
