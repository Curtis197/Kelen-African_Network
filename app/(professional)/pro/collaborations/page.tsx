...
export default function ProCollaborationsPage() {
  ...
  console.log("[ProCollaborationsPage] Render, count:", collaborations.length);

  useEffect(() => {
    const fetchCollaborations = async () => {
      console.log("[ProCollaborationsPage] Fetching collaborations...");
      ...
      if (!professional) { setIsLoading(false); return; }
      ...
      console.log("[ProCollaborationsPage] Fetched:", { count: data?.length, error: error?.message });
