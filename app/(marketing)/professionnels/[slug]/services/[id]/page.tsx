...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!service) return { title: "Service non trouvé | Kelen" };

  return {
    title: `${service.title} | Service Kelen`,
    description:
      service.description || "Consultez le détail de ce service sur Kelen.",
  };
}
...
export default async function ServiceDetailPage({ params }: Props) {
  ...
  // Images
  const allImages: any[] = service.service_images ?? [];
                    ...
                    <div className="flex items-start gap-3 md:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#1a1c1c] font-semibold text-base md:text-lg">
                          {formatPrice(service.price, service.currency || "XOF")}
                        </p>
                      </div>
                    </div>
                  )}
          ...
          <div className="bg-[#2f3130] rounded-[2rem] p-8 md:p-16 overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-12 relative">
            ...
            <div className="relative z-10 flex-grow text-center md:text-left">
              ...
              <p className="text-base md:text-lg text-white/70 mb-6 md:mb-8 max-w-xl">
                Contactez {pro.business_name} directement pour discuter de vos
                besoins et obtenir un devis personnalisé.
              </p>
